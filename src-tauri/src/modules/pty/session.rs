...
const AGENT_EVENT: &str = "micah:agent-signal";
...
const OVERFLOW_NOTICE: &[u8] =
    b"\x1bc\x1b[2m[micah: dropped output due to backpressure]\x1b[0m\r\n";
