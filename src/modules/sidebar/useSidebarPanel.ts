...
const SIDEBAR_WIDTH_STORAGE_KEY = "micah.sidebar.width";
const SIDEBAR_VIEW_STORAGE_KEY = "micah.sidebar.view";
const SIDEBAR_COLLAPSED_STORAGE_KEY = "micah.sidebar.collapsed";
