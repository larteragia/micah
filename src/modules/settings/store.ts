...
export const DEFAULT_THEME_ID = "micah-default";
...
const STORE_PATH = "micah-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "micah://prefs-changed";
...
export async function setClaudeCodeSkipPermissions(
  value: boolean,
): Promise<void> {
  await writePref(KEY_CLAUDE_CODE_SKIP_PERMISSIONS, value);
}
...
const KEYS_CHANGED_EVENT = "micah://ai-keys-changed";
