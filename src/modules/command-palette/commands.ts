...
export function createCommandItems(
  ...
  return [
    ...
    },
    {
      ...
      title: "New window",
      group: "General",
      keywords: ["window", "second", "instance", "duplicate", "open"],
      icon: AppWindowIcon,
    ...
    {
      id: "browser.toggle",
      title: ctx.browserEnabled
        ? "Turn off the browser panel"
        : "Turn on the browser panel",
      group: "View",
      keywords: ["browser", "web", "chromium", "playwright", "cdp", "panel"],
      icon: Globe02Icon,
      run: ctx.toggleBrowser,
    },
    {
      id: "ai.toggle",
