    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="Alert when a coding agent needs your input or finishes. Native notification when Micah is unfocused, in-app otherwise."
        >
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <SettingRow
            ...
            description="Open Micah automatically when you sign in."
          >
            <Switch
              checked={autostart}
...
function notificationTestTitle(status: NotificationTestState): string {
  switch (status) {
    ...
    case "failed":
      return "Micah could not request a native notification";
    default:
