...
Micah is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about Micah. Take off-topic conversations elsewhere.
...
This applies to everything inside the project: issues, PRs, discussions, commits, and any community space we create later (chat, forums, etc.).

## Enforcement

If you see a violation - or experience one - open a private report to the maintainer at [@larteragia](https://github.com/larteragia) (GitHub, subject `[Micah conduct]`). Include links and context.
