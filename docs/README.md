# Micah contributor documentation

This directory holds long-form contributor and maintainer guides. `MICAH.md` at the repo root is the living architecture doc and the source of truth; these guides elaborate on specific areas without duplicating it.

If a guide conflicts with `MICAH.md`, `MICAH.md` wins.

## Getting started

- [MICAH.md](../MICAH.md) - the architecture source of truth; read this first
