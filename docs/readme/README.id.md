<div align="center">
  ...
  <p><a href="https://github.com/larteragia/micah">Situs web</a> · <a href="https://github.com/larteragia/micah/tree/main/docs">Dokumentasi</a> · <a href="https://github.com/larteragia/micah">Kode sumber situs web</a></p>

  <p>
    <img src="https://img.shields.io/github/v/release/larteragia/micah?label=version&color=blue" alt="versi" />
    <img src="https://img.shields.io/github/downloads/larteragia/micah/total?label=downloads&color=blue" alt="unduhan" />
...
- **Alur kerja berbasis agen:** rencana, subagen, memori proyek melalui `MICAH.md`, baca / tulis / sunting / multisunting / grep / glob, bash dengan persetujuan, dan proses latar belakang
...
Penginstal terbaru tersedia di halaman [Releases](https://github.com/larteragia/micah/releases/latest). Micah melakukan pembaruan otomatis dari sana.
...
- **Arch / AUR:** `yay -S micah-bin` atau `paru`. Paket mengikuti rilis terbaru.
- **NixOS / Nix:** gunakan flake resmi. Di luar NixOS, jalankan `nix profile install github:larteragia/micah`. Di NixOS, impor flake dan tambahkan `inputs.micah.packages.${pkgs.system}.micah` ke `environment.systemPackages`. `nixosModules.micah` juga tersedia untuk pengaturan yang lebih sederhana.
- **AppImage:** memerlukan FUSE. Tanpanya, jalankan `./Micah_*.AppImage --appimage-extract-and-run`. Jika ada masalah perenderan di Wayland, coba `WEBKIT_DISABLE_DMABUF_RENDERER=1`. Paket `.deb` / `.rpm` menggunakan stack GTK sistem dan biasanya lebih lancar.

## Konfigurasi AI

1. Buka **Pengaturan -> AI**.
2. Pilih penyedia dan tempel kunci API. Untuk inferensi lokal, arahkan Micah ke endpoint LM Studio / MLX / Ollama.
...
Micah dilisensikan di bawah Apache-2.0. Untuk informasi tentang dependensi, lihat [Apache License 2.0](../../LICENSE).
